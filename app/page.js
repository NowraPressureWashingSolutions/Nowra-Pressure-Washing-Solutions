      ...
      <header id="hdr">
        <div className="wrap nav">
          ...
          <div className="nav-right">
            <a className="nav-phone" href="tel:+61415743924"><span>Call today</span>0415 743 924</a>
        ...
        <nav className="mnav" id="mnav">
          ...
          <a href="#area">Service area</a>
          <a href="#faq">FAQ</a>
          <a href="tel:+61415743924">Call 0415 743 924</a>
          <a className="btn btn-hi" href="#quote">Get a free quote</a>
        </nav>
      </header>
          ...
          <div className="wrap hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <a className="btn btn-hi" href="#quote">Get a free quote</a>
                <a className="btn btn-ghost" href="tel:+61415743924">Call 0415 743 924</a>
              </div>
              <div className="trust">
          ...
          <div className="wrap quote-grid">
            <div className="reveal">
              ...
              <div className="contactlist">
                <a href="tel:+61415743924"><span className="ci"><svg viewBox="0 0 24 24"><path d="M5 4h4l2 5-3 2a12 12 0 0 0 5 5l2-3 5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 3 6a2 2 0 0 1 2-2z" /></svg></span>0415 743 924</a>
            ...
            <form className="qform reveal" id="quoteForm" noValidate>
              ...
              <p className="hint">Opens your email app with the details ready to send. Prefer to talk? Call 0415 743 924.</p>
            </form>
          </div>
        </section>
      </main>
      ...
      <footer>
        <div className="wrap">
          <div className="foot-grid">
            ...
            <div className="foot-col">
              <h4>Contact</h4>
              <a href="tel:+61415743924">0415 743 924</a>
